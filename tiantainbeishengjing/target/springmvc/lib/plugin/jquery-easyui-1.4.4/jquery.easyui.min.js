...
$.fn.validatebox.defaults={required:false,validType:null,validParams:null,delay:200,missingMessage:"该字段是必需的。",invalidMessage:null,tipPosition:"right",deltaX:0,novalidate:false,events:{focus:_488,blur:_48c,mouseenter:_490,mouseleave:_493,click:function(e){
var t=$(e.data.target);
if(!t.is(":focus")){
t.trigger("focus");
}
...
},message:"请输入正确的邮箱号码！"},url:{validator:function(_4b3){
...
},message:"请输入介于{0} 和 {1} 之间的值。"},remote:{validator:function(_4b6,_4b7){
var data={};
data[_4b7[1]]=_4b6;
...
},beforeSend:function(xhr){//jianghaipeng add header token
